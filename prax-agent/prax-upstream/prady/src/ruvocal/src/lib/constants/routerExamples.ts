...
// Prady-themed router examples — shown on the empty-state welcome screen
...
export const routerExamples: RouterExample[] = [
	...
	{
		title: "Memory & recall",
		prompt: "Explain how Prady's persistent memory works across sessions, and give me a 3-step example of saving a preference and recalling it later.",
		followUps: [
			{
				title: "Namespaces",
	...
	},
	{
		...
		prompt: "I'm starting a 4-week migration. How should I structure horizon tracking, milestone checkpoints, and drift detection in Prady?",
		followUps: [
			{
	...
	},
	{
		...
		followUps: [
			...
			{
				title: "Offline",
				prompt: "What can Prady still do if my network drops?",
			},
		],
	},
];
