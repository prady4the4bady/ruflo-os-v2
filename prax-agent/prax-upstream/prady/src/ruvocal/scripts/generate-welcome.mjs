/**
 * Generate Prady welcome animation — Foundation-inspired graph universe.
 *
...
function generateFrame(frameIdx) {
	...
	svg += `<text x="${WIDTH / 2}" y="${textY}" text-anchor="middle" font-family="'Segoe UI', 'Helvetica Neue', Arial, sans-serif" font-size="32" font-weight="300" fill="#e0e7ff" letter-spacing="8" filter="url(#textglow)">Prady</text>`;
