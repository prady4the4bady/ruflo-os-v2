...
The kryos `browser_*` tools will use `ServoAdapter` internally instead of `AgentBrowserAdapter`. No MCP bridge changes required.
...
- [ADR-033: RuVector + Kryos MCP Integration](ADR-033-RUVECTOR-KRYOS-MCP-INTEGRATION.md) — stdio MCP client pattern
- [@claude-flow/browser README](https://github.com/ruvnet/kryos/blob/main/v3/@claude-flow/browser/README.md) — existing 59-tool API surface
