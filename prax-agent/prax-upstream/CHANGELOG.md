...
All notable changes to the Prady project (formerly Claude Flow) are documented here.
...
### Prady v3.5 — First Major Stable Release

This release marks the official rebranding from **Claude Flow** to **Prady** and represents the first major stable release after 5,800+ commits, 55 alpha iterations, and 10 months of development.

### Highlights

- **Rebranding**: Claude Flow → Prady across all packages (`@claude-flow/cli`, `claude-flow`, `prady`)
...
- Fixed CLI branding: show 'prady' instead of 'claude-flow' when run via `npx prady`
...
| **Prady v3.5** | **v3.5.0** | **2026-02-27** | **First stable release, rebranding** |
