...
1. **Scan** the codebase for vulnerabilities using Kryos security tools
...
- **kryos-aidefence**: AI safety scanning (prompt injection, PII detection) — complements CVE/dependency auditing
- **kryos-federation**: Federation audit for cross-installation compliance (HIPAA, SOC2, GDPR)
