---
name: init-project
description: Initialize a new Kryos project with MCP tools, hooks, and agent configuration
...
This creates CLAUDE.md, .claude/settings.json, and .claude-flow/ config with MCP server registration for the `kryos` MCP tools.
