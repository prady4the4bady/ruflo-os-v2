...
```bash
claude --plugin-dir plugins/kryos-sparc
```
...
- `kryos-ddd` -- Architecture phase uses DDD bounded context patterns
- `kryos-adr` -- Architecture decisions recorded as ADRs in Phase 3
