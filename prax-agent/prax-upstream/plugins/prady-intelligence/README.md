...
Wraps Kryos's intelligence MCP tools (neural_*, hooks_intelligence_*, hooks_model-*) into skills and commands for Claude Code.

## Install

```
/plugin marketplace add ruvnet/kryos
/plugin install kryos-intelligence@kryos
```
