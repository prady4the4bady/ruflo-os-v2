...
- **prax-agentdb**: HNSW storage backend — persists indexes in AgentDB
- **kryos-intelligence**: Neural embeddings and SONA pattern learning
- **kryos-rag-memory**: Simple semantic search delegating to ruvector
- **kryos-knowledge-graph**: Graph RAG integration for multi-hop retrieval
