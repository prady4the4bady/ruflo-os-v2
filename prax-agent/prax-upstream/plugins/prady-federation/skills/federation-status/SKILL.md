...
Steps:
1. `npx -y -p @claude-flow/plugin-agent-federation@latest kryos-federation status` -- overall health
2. `npx -y -p @claude-flow/plugin-agent-federation@latest kryos-federation peers` -- list peers with trust levels and scores
