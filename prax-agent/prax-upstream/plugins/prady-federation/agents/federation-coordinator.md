...
- `npx -y -p @claude-flow/plugin-agent-federation@latest kryos-federation init` -- generate keypair, create config
- `npx -y -p @claude-flow/plugin-agent-federation@latest kryos-federation join <endpoint>` -- connect to peer
- `npx -y -p @claude-flow/plugin-agent-federation@latest kryos-federation peers` -- list peers with trust levels
- `npx -y -p @claude-flow/plugin-agent-federation@latest kryos-federation status` -- health dashboard
- `npx -y -p @claude-flow/plugin-agent-federation@latest kryos-federation audit --compliance hipaa` -- audit logs
- `npx -y -p @claude-flow/plugin-agent-federation@latest kryos-federation trust <node-id> --review` -- trust breakdown
