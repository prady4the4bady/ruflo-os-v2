...
- **kryos-observability**: Real-time risk dashboards and alerting
- **kryos-cost-tracker**: PnL tracking and fee attribution
- **prax-agentdb**: Historical risk event storage for pattern matching
