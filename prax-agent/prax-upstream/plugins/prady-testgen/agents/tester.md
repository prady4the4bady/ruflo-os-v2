...
- **kryos-intelligence**: Coverage-gap routing uses intelligence pipeline to prioritize test generation
- **kryos-browser**: Playwright browser testing for UI-facing test gaps
