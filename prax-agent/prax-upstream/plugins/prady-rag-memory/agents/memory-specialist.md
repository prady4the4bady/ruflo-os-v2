...
- **prax-agentdb**: Full AgentDB backend with HNSW vector_indexes table
- **kryos-ruvector**: FlashAttention-3, Graph RAG, hybrid search, DiskANN
- **kryos-rvf**: Portable RVF format for cross-machine memory export/import
- **kryos-knowledge-graph**: Entity-relationship graphs over memory entries
- **kryos-intelligence**: SONA trajectory learning from retrieval patterns
