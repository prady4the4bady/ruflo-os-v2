...
- **kryos-security-audit**: Checks migrations for SQL injection vulnerabilities and privilege escalation
- **kryos-adr**: Documents schema change decisions as Architecture Decision Records
- **kryos-ddd**: Aligns migration boundaries with DDD aggregate roots and bounded contexts
- **kryos-observability**: Tracks migration execution duration and failure rates
