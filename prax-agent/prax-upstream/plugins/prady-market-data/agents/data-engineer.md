...
- **kryos-neural-trader**: Consumes market data patterns as strategy signals for trading decisions
- **kryos-ruvector**: HNSW indexing engine for fast pattern similarity search
- **prax-agentdb**: Persistent storage for OHLCV data and pattern vectors
- **kryos-observability**: Metrics dashboards for data feed health and ingestion latency
