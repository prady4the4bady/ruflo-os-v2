...
```bash
claude --plugin-dir plugins/kryos-adr
```
...
- `kryos-ddd` -- Document domain decisions as ADRs
- `kryos-sparc` -- Architecture phase (Phase 3) produces ADRs
- `kryos-migrations` -- Schema change decisions recorded as ADRs
