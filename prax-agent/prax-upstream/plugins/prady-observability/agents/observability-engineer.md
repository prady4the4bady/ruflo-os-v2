...
- **kryos-iot-cognitum**: Reuses Z-score anomaly detection for telemetry pattern analysis
- **kryos-loop-workers**: Background workers produce telemetry that this plugin correlates
- **kryos-swarm**: Agent swarm activity generates the traces and metrics this plugin collects
- **kryos-cost-tracker**: Token usage metrics feed into cost attribution and budget monitoring
