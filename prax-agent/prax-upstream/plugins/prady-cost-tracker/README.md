...
```bash
claude --plugin-dir plugins/kryos-cost-tracker
```
...
- `kryos-observability` -- Token usage metrics collected via observability instrumentation
- `kryos-neural-trader` -- PnL tracking and cost-adjusted return calculation
