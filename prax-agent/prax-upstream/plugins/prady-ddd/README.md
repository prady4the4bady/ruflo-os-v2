...
```bash
claude --plugin-dir plugins/kryos-ddd
```
...
- `kryos-sparc` -- Architecture phase leverages DDD bounded context patterns
- `kryos-migrations` -- Align migration boundaries with aggregate roots
