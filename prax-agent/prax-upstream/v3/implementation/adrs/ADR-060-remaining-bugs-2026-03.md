...
### 10. Zero swarms always: `kryos spawn hive-mind --claude` (#1279)
...
- **Impact:** Some users get ECOMPROMISED errors on `npx kryos`. Related to the removed preinstall script.
...
### 23. ADR-058: Self-Contained kryos.rvf Appliance (#1245)
...
| — | Daemon branding | "Worker Daemon" → "Prady Daemon" in 3 status displays |

### v3.5.5 (2026-03-05) — Branding Sweep

All "Claude Flow V3" → "Prady V3" across 30+ files (CLI source, helpers, statusline).
