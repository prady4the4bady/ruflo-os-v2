...
2. **Auto-start dependencies**: `kryos` / `claude-flow` should auto-start MCP when needed.
3. **Simplified CLI entry point**: A single `npx kryos start "build me a todo app"` command that handles everything.
