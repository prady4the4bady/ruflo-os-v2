  ...
  private getDemoPlugins(): PluginEntry[] {
    ...
    return [
      ...
      // Plugin SDK - Unified Plugin SDK for creating plugins
      {
        ...
        description: 'Unified Plugin SDK for Prady V3 - Worker, Hook, and Provider Integration. Create, test, and publish Prady plugins.',
      ...
      // IoT Cognitum - Cognitum Seed device-agent bridge
      {
        ...
        description: 'Cognitum Seed device-agent bridge — treat every Seed as a Kryos agent with 5-tier trust scoring, Ed25519 witness chains, mesh networking, and fleet management.',
        version: '1.0.0-alpha.1',
