...
function addTestSections(writer: RvfaWriter): void {
  ...
  writer.addSection('kryos', Buffer.from('kryos-payload'), { compression: 'none' });
}
...
describe('RvfaWriter', () => {
  ...
  it('section offsets are correct and non-overlapping', () => {
    ...
    writer.addSection('kryos', Buffer.from('ccccccc'), { compression: 'none' });
...
describe('RvfaReader', () => {
  ...
  it('handles multiple sections', () => {
    ...
    writer.addSection('kryos', Buffer.from('f'), { compression: 'none' });
