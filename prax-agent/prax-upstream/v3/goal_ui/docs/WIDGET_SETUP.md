# Prady Research Widget - Embeddable Research Interface
...
<head>
  ...
  <title>My Site with Prady Research Widget</title>
</head>
<body>
  <!-- Widget Container -->
...
The widget exposes a global `KryosResearchWidget` object:
...
- Customize via `KryosResearchWidgetConfig`
...
- Review console logs with `[Prady Research]` prefix
