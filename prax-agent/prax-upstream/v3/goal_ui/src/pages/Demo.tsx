...
const Demo = () => {
  ...
  const embedCode = `<!-- Prady Research Widget -->
...
<script src="${window.location.origin}/widget.js"></script>`;
  ...
  useEffect(() => {
    ...
    (window as any).KryosResearchWidgetConfig = {
      primaryColor: "#8b5cf6",
      accentColor: "#22c55e",
      backgroundColor: "#1a1a1a",
      cardBackgroundColor: "#262626",
    ...
    const checkWidget = async () => {
      ...
      try {
        ...
        script.onload = () => {
          ...
          if ((window as any).KryosResearchWidget) {
            console.log("[Demo] Widget version:", (window as any).KryosResearchWidget.version);
            toast({
              title: "Widget Ready",
              description: "Prady Research Widget loaded successfully",
            });
          }
        };
        script.onerror = () => {
      ...
      return () => {
        ...
        // Clear widget config
        delete (window as any).KryosResearchWidgetConfig;
        delete (window as any).KryosResearchWidget;
      };
    };
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="border-t border-border pt-8">
          ...
          {/* Widget Container */}
          <div
            id="kryos-research-widget-container"
